...
#define neigh_for_each_in_bucket(pos, head) hlist_for_each_entry(pos, head, struct neighbour, hash)
#define neigh_for_each_in_bucket_rcu(pos, head) \
	hlist_for_each_entry_rcu(pos, head, struct neighbour, hash)
#define neigh_for_each_in_bucket_safe(pos, tmp, head) \
	hlist_for_each_entry_safe(pos, tmp, struct neighbour, hash)
